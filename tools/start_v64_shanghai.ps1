...
$logPath = Join-Path $projectRoot "logs\lmpc_shanghai_v64_fullbrake_300_5lap.csv"
$outPath = Join-Path $projectRoot "logs\lmpc_shanghai_v64_fullbrake_300_5lap.out.log"
$errPath = Join-Path $projectRoot "logs\lmpc_shanghai_v64_fullbrake_300_5lap.err.log"
...
Write-Output "V64 launcher PID: $($process.Id)"
