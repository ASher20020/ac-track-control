...
\section{Steering calibration relation}

The steady-state steering relation is
...
where $L$ is the wheelbase, $k$ is the steering-axis scale, and $K$ is the
understeer gradient. A linear least-squares fit of
$u v/r$ against $v^2$ yields $L/k$ and $K/k$.
